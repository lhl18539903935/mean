   ...
   import VueFileUpload from 'vue-file-upload';
    export default {
      components:{
       ...
       data(){
        return{
          ...
          pageHeader:true,
          pageName:"身份证背面",
          addimg:require('../../assets/images/peoo.png'),
          autoUpload:true,
          option:{
              formData:{},
          ...
          even:{
              onCompleteUpload:(file,response,status,header)=>{
               ...
               console.log(response)
                let pic_url=response.data.pic_url;
                this.addimg=pic_url
                this.apiPost("http://r.huileyi.com/home/uploadPersonDatum",{headpic:this.addimg}).then((res)=>{
                console.log(res)
      ...
      methods:{
        ...
        save(){
          let vm=this
          let data={card_negative_img:this.addimg,uptype:'companyAuthen'}
        ...
        getDate(){
          ...
          this.apiPost('http://p.huileyi.com/Dls/companyAuthen',{}).then((res)=>{
            ...
            if(res.code==200){
              ...
              vm.addimg=res.data.headpic?res.data.headpic:vm.addimg
            }
          })
        }
      },
