<template>
  <div class='phone'>
    ...
    <div style="width:90%;margin:1rem auto;"><x-button style="background-color: #FF4948;font-size: 16px;color:#fff;" link="replace">更换手机号</x-button></div>
...
<style>
  .phone .weui-input{text-align: right;}
</style>
